...
class Streamer:
    ...
    def __init__(self):
        ...
        print('[SerBot] ', 'OpenCL : ', cv2.ocl.haveOpenCL())        # CPU보다 OpenCL 성능이 더 그래픽 처리 성능이 더 좋기에 만약 해당 PC가 사용시 Active
        if cv2.ocl.haveOpenCL() :
            cv2.ocl.setUseOpenCL(True)
            print('[SerBot] ', 'OpenCL Active')
        else :
            print('[SerBot] ', 'OpenCL Deactive')
    ...
    def __exit__(self):
        print("[SerBot] Closed Streamer. Bye.")